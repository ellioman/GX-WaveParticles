...
public static class DebugExtension
{
	...
	/// 	- The size of the drawn point.
	/// </param>
	public static void DrawCoords(Transform transform, float scale = 1.0f)
	{
		Color oldColor = Gizmos.color;

		Gizmos.color = Color.red;
		Gizmos.DrawRay(transform.position + (Vector3.right * (scale * 0.5f)), -Vector3.right * scale * 0.5f);
		Gizmos.color = Color.white;
		Gizmos.DrawRay(transform.position, -Vector3.right * scale * 0.5f);
		Gizmos.color = Color.green;
		Gizmos.DrawRay(transform.position + (Vector3.up * (scale * 0.5f)), -Vector3.up * scale * 0.5f);
		Gizmos.color = Color.white;
		Gizmos.DrawRay(transform.position, -Vector3.up * scale * 0.5f);
		Gizmos.color = Color.blue;
		Gizmos.DrawRay(transform.position + (Vector3.forward * (scale * 0.5f)), -Vector3.forward * scale * 0.5f);
		Gizmos.color = Color.white;
		Gizmos.DrawRay(transform.position, -Vector3.forward * scale * 0.5f);
